# AIRAC 2604 manual curation note

Date: 2026-04-16

Purpose: remove illegal SRD route rows from the live AIRAC 2604 input before rerunning New-SRDParser, while preserving an audit trail of what was removed and why.
...
- Worksheet line 11773 (`EGNCLAMSO002`)
...
- Worksheet line 21213 (`EGXWGOREV001`)
...
- Worksheet line 21231 (`EGXWNIVUN001`)
...
- Worksheet line 21264 (`EGXWVAXIT001`)
